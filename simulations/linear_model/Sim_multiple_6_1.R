...
# num_med = 2; alpha_coef =  c(0, 0); beta_coef = c(0,0); lambda1all = 2; lambda2all = lambda1all;
num_med = 1;  #set number of mediators
alpha_coef = rep(0,num_med); beta_coef = rep(0, num_med); lambda1all = 2; lambda2all = lambda1all;
